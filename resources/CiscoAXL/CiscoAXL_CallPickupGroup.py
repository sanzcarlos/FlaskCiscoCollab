...
class CiscoAXL_CallPickupGroup(Resource):
    def get(self):
        ...
        return {'Class': 'CallPickupGroup','AXL': 'get','Method': 'GET', 'Status': 'ERROR', 'Detail': 'No esta definida la funcion'},400

    def post(self):
        # * Funcion para crear un elemento
        infoLogger = logging.getLogger('FlaskCiscoCollab')
        infoLogger.debug('Ha accedido a la funcion post de la clase CiscoAXL_Template' )
        return {'Class': 'CallPickupGroup','AXL': 'add','Method': 'POST', 'Status': 'ERROR', 'Detail': 'No esta definida la funcion'},400
    ...
    def delete(self):
        ...
        return {'Class': 'CallPickupGroup','AXL': 'remove','Method': 'DELETE', 'Status': 'ERROR', 'Detail': 'No esta definida la funcion'},400
